      ...
      <div className={styles.scrollContent}>
          ...
          <div className="lg:pr-40 lg:pt-20">
            <div className="flex flex-col md:flex-row items-center md:items-start">
              <div className="space-y-1">
                ...
                <div
                  className={`w-96 h-14 bg-gradient-to-r text-white from-yellow-500 via-yellow-300 to-yellow-100 -rotate-4 flex text-center justify-center text-4xl items-center font-['Bebas_Neue'] rounded-xl shadow-xl hover-element ${montserrat.className}`}
                >
                  <h1 className="text-4xl font-black">BUT TRADITIONAL</h1>
                </div>
                <div
                  className={`w-[26rem] h-14 bg-gradient-to-r text-white from-orange-500 via-orange-300 to-orange-100 -rotate-2 flex text-center justify-center text-3xl font-black items-center font-['Bebas_Neue'] rounded-xl shadow-xl hover-element ${montserrat.className}`}
                >
                  <h1>ISN’T SIMPLE ANYMORE</h1>
                </div>
                <p
                  className={`pt-10 lg:w-[36rem] w-96 lg:text-2xl text-base font-semibold hover-element reveal-text ${poppins.className}`}
                >
        ...
        <div className={`${styles.section} section`}>
          <div className="flex flex-col items-center lg:pl-44">
            <div>
              <div
                className={`p-6 text-center flex justify-center items-center rounded-2xl bg-gradient-to-r from-green-500 via-yellow-100 to-green-50 shadow-2xl hover-element ${montserrat.className}`}
              >
              ...
              <div className="lg:flex lg:flex-wrap lg:justify-center mt-5 p-5 lg:items-center">
                <div
                  className={`lg:text-xl mt-5 font-semibold font-sans w-[20rem] lg:w-[36rem] space-y-4 ${poppins.className}`}
                >
                  <h1 className="text-4xl font-bold">THE BIG PROBLEMS 😕:</h1>
                  <p>No one wants to see your boring ads between television, driving on the highway, waiting on the traffic signal or when someone makes them hold a flyer.</p>
                </div>
                <ul
                  className={`lg:text-xl mt-5 font-semibold font-sans w-[20rem] lg:w-[40rem] ${poppins.className}`}
                >
        ...
        <div className={`${styles.section} section`}>
          <div className="">
            <h1
              className={`text-[4rem] text-center font-black w-96 uppercase ${montserrat.className}`}
            >
              THE BIG SOLUTION:
            </h1>
          </div>
